...
# This FastLeFF class is commented out because it has a problematic import (torch_dwconv) that is not being maintained
...
class LeWinTransformerBlock(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, win_size=8, shift_size=0,
        ...
        # This is commented out because the FastLeFF class has a problematic import (torch_dwconv) that is not being maintained
